...
https://www.tiktok.com/@perfectbalance19891/live
room_id from hayate (tmp banned): 
```
7489532596213959446
```
...
```
python3 main.py -room_id 7489532596213959446 -mode automatic -output /home/user/tt
```



```
python3 main.py -room_id 7492759544498817814 -mode automatic -output /home/user/tt
```
